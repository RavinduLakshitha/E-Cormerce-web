    ...
    <aside className="product-page-sidebar">
      ...
      <div className="product-category">
        ...
        <div className="checkbox-item">
          <input
            onChange={() => {
              setFictionCategoryCheckbox((prevState) => !prevState);
              dispatchProductFilterOptions({ type: "UPDATE_FICTION_FILTER" });
            }}
            id="fiction-checkbox"
            type="checkbox"
        ...
        <div className="checkbox-item">
          <input
            onChange={() => {
              setThrillerCategoryCheckbox((prevState) => !prevState);
              dispatchProductFilterOptions({ type: "UPDATE_THRILLER_FILTER" });
            }}
        ...
        <div className="checkbox-item">
          <input
            onChange={() => {
              setTechCategoryCheckbox((prevState) => !prevState);
              dispatchProductFilterOptions({ type: "UPDATE_TECH_FILTER" });
            }}
            id="tech-checkbox"
            type="checkbox"
        ...
        <div className="checkbox-item">
          <input
            onChange={() => {
              setPhilosophyCategoryCheckbox((prevState) => !prevState);
              dispatchProductFilterOptions({
                type: "UPDATE_PHILOSOPHY_FILTER",
              });
            }}
        ...
        <div className="checkbox-item">
          <input
            onChange={() => {
              setRomanceCategoryCheckbox((prevState) => !prevState);
              dispatchProductFilterOptions({ type: "UPDATE_ROMANCE_FILTER" });
            }}
            id="romance-checkbox"
            type="checkbox"
        ...
        <div className="checkbox-item">
          <input
            onChange={() => {
              setMangaCategoryCheckbox((prevState) => !prevState);
              dispatchProductFilterOptions({ type: "UPDATE_MANGA_FILTER" });
            }}
            id="manga-checkbox"
            type="checkbox"
